export default class StereoCamera {
    ...
    getLeftProjectionMatrix() {
        return this.applyLeftFrustum().projection;
    }

    getRightProjectionMatrix() {
        return this.applyRightFrustum().projection;
    }

    getLeftViewOffsetMatrix() {
        return this.applyLeftFrustum().modelView;
    }

    getRightViewOffsetMatrix() {
        return this.applyRightFrustum().modelView;
    }
}